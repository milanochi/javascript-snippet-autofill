# Uber login autofill snippet

- Head over to Uber's [site](https://www.uber.com/)
- Click "Sign in" and choose "Rider Sign in"
- Use [this link](https://auth.uber.com/v2/?breeze_local_zone=dca22&next_url=https%3A%2F%2Friders.uber.com%2F&state=RDLfOaGhfSqmrsWW7UGUYtbwt5jYJdtUG80SwvgXYMs%3D) to get to the sign-in page directly.

> **PROBLEM:**  
> Whip up a JavaScript snippet that can be pasted into Chrome DevTools. It should automatically fill in a value for "Email or mobile number" and then simulate pressing "Enter".

## JavaScript Snippet
> The following code snippet is the final solution to the challenge.
```js
